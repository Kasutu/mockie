...
pipeline {
  ...
  post {
    success {
      discordSend description: 'Build PASSED ✅', enableArtifactsList: false, footer: 'ci.splitscale.systems', image: '', link: '${env.BUILD_URL}', result: 'SUCCESS', scmWebUrl: 'https://github.com/splitscale/mockie', thumbnail: 'https://vignette.wikia.nocookie.net/disney/images/6/6b/Incredibles_2_-_Concept_Art_-_Mr._Incredible.jpg/revision/latest?cb=20180802115635', title: '${env.JOB_NAME}', webhookURL: '${DISCORD_WEBHOOK_URL}'
     }

    failure {
      discordSend description: 'Build FAILED ❌', enableArtifactsList: false, footer: 'ci.splitscale.systems', image: '', link: '${env.BUILD_URL}', result: 'FAILURE', scmWebUrl: 'https://github.com/splitscale/mockie', thumbnail: 'https://preview.redd.it/7yjyx0pq1s9a1.png?width=393&format=png&auto=webp&s=451ed3d625145389b1c0554e660382ed21e05f42', title: '${env.JOB_NAME}', webhookURL: '${DISCORD_WEBHOOK_URL}'
     }
  }
}
